...
class FlxMatrix extends Matrix
{
	 ...
	 */
	public function rotateBy180():FlxMatrix
	{
	 ...
	 * @return	rotated matrix
	 */
	public function rotateByPositive90():FlxMatrix
	{
	 ...
	 * @return	rotated matrix
	 */
	public function rotateByNegative90():FlxMatrix
	{
		this.setTo(b, -a, d, -c, ty, -tx);
		return this;
	}
	 ...
	 * @since 4.3.0
	 */
	public function transformX(px:Float, py:Float):Float
	{
		return px * a + py * c + tx;
	}
	 ...
	 * @since 4.3.0
	 */
	public function transformY(px:Float, py:Float):Float
	{
		return px * b + py * d + ty;
	}
