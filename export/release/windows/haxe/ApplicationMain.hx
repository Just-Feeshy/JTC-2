...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("FNF - Feeshmora", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("FNF - Feeshmora", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "7";
		app.meta["company"] = "feeshy";
		app.meta["file"] = "FNF - Feeshmora";
		app.meta["name"] = "Friday Night Funkin' - Feeshmora";
		app.meta["packageName"] = "com.feeshypoo.feeshx";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "Friday Night Funkin' - Feeshmora",
			width: 1280,
			x: null,
			y: null,
		};
