...
class HXCPP_CLASS_ATTRIBUTES TitleState_obj : public  ::MusicBeatState_obj
{
	...
	public:
		...
		static bool initialized;
		 ...
		 ::flixel::group::FlxTypedSpriteGroup userIcon;
		 ::flixel::group::FlxTypedGroup userName;
		...
		void addMoreText(::String text,::Array< ::String > image);
		...
		int sortByShit(::String str1,::String str2);
