...
HX_DECLARE_STACK_FRAME(_hx_pos_a2c5aad29e94c731_932_new)
...
HXLINE( 933)		( ( ::flixel::group::FlxTypedGroupIterator)(__this) )->_groupMembers = GroupMembers;
HXLINE( 934)		( ( ::flixel::group::FlxTypedGroupIterator)(__this) )->_filter = filter;
HXLINE( 935)		( ( ::flixel::group::FlxTypedGroupIterator)(__this) )->_cursor = 0;
HXLINE( 936)		( ( ::flixel::group::FlxTypedGroupIterator)(__this) )->_length = ( ( ::flixel::group::FlxTypedGroupIterator)(__this) )->_groupMembers->get_length();
            	}
