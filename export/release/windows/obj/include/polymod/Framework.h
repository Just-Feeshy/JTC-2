...
class Framework_obj : public ::hx::EnumBase_obj
{
	...
	public:
		...
		static ::polymod::Framework CASTLE;
		static inline ::polymod::Framework CASTLE_dyn() { return CASTLE; }
		static ::polymod::Framework CUSTOM;
		static inline ::polymod::Framework CUSTOM_dyn() { return CUSTOM; }
		static ::polymod::Framework FLIXEL;
		static inline ::polymod::Framework FLIXEL_dyn() { return FLIXEL; }
