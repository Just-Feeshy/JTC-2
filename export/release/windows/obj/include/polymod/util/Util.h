...
class HXCPP_CLASS_ATTRIBUTES Util_obj : public ::hx::Object
{
	...
	public:
		...
		static ::Array< ::String > filterUnique_String(::Array< ::String > input);
		static ::Dynamic filterUnique_String_dyn();

		static ::Array< ::String > listAllParentDirs(::String filePath);
		static ::Dynamic listAllParentDirs_dyn();
