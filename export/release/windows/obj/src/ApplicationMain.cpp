...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("FNF - Feeshmora",77,3a,8e,d4),::ApplicationMain_obj::create_dyn());
...
HXLINE(  36)		app->meta->set(HX_("company",3d,15,69,83),HX_("feeshy",be,8f,f9,32));
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("FNF - Feeshmora",77,3a,8e,d4));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Friday Night Funkin' - Feeshmora",66,96,77,04));
HXLINE(  39)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.feeshypoo.feeshx",e6,26,1f,1d));
...
HXLINE(  46)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Friday Night Funkin' - Feeshmora",66,96,77,04))
