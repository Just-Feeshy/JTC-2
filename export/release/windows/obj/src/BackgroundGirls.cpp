...
HXDLIN(  13)		 ::Dynamic cache = null();
HXDLIN(  13)		::String cacheFile = HX_("",00,00,00,00);
HXDLIN(  13)		if (( (bool)(cache) )) {
HXLINE(  13)			cacheFile = HX_("cache/",ad,5f,f2,b0);
            		}
HXDLIN(  13)		if (::sys::FileSystem_obj::exists((HX_("mod_assets/images/",c8,63,40,54) + HX_("weeb/bgFreaks",d9,71,bd,0f)))) {
HXLINE(  13)			cacheFile = HX_("",00,00,00,00);
            		}
HXDLIN(  13)		 ::flixel::graphics::frames::FlxAtlasFrames _hx_tmp;
HXDLIN(  13)		::String cacheFile1 = HX_("",00,00,00,00);
HXDLIN(  13)		if (( (bool)(cache) )) {
HXLINE(  13)			cacheFile1 = HX_("cache/",ad,5f,f2,b0);
            		}
HXDLIN(  13)		if (::sys::FileSystem_obj::exists((HX_("mod_assets/images/",c8,63,40,54) + HX_("weeb/bgFreaks",d9,71,bd,0f)))) {
HXLINE(  13)			cacheFile1 = HX_("",00,00,00,00);
            		}
HXDLIN(  13)		if (::lime::utils::Assets_obj::exists(::Paths_obj::getPath((((HX_("images/",77,50,74,c1) + cacheFile1) + HX_("weeb/bgFreaks",d9,71,bd,0f)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library),null())) {
HXLINE(  13)			if (::hx::IsNotNull( ::Paths_obj::ifImageCached((cacheFile + HX_("weeb/bgFreaks",d9,71,bd,0f))) )) {
HXLINE(  13)				 ::flixel::graphics::FlxGraphic _hx_tmp1 = ::Paths_obj::ifImageCached((cacheFile + HX_("weeb/bgFreaks",d9,71,bd,0f)));
HXDLIN(  13)				_hx_tmp = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp1,::Paths_obj::getPath((((HX_("images/",77,50,74,c1) + cacheFile) + HX_("weeb/bgFreaks",d9,71,bd,0f)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library));
            			}
            			else {
HXLINE(  13)				::String _hx_tmp1 = ::Paths_obj::image((cacheFile + HX_("weeb/bgFreaks",d9,71,bd,0f)),library);
HXDLIN(  13)				_hx_tmp = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp1,::Paths_obj::getPath((((HX_("images/",77,50,74,c1) + cacheFile) + HX_("weeb/bgFreaks",d9,71,bd,0f)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library));
            			}
            		}
            		else {
HXLINE(  13)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown((HX_("Error: could not locate asset - ",17,30,f9,e8) + ::Paths_obj::getPath((((HX_("images/",77,50,74,c1) + cacheFile) + HX_("weeb/bgFreaks",d9,71,bd,0f)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library))));
            		}
