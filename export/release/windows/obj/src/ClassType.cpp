...
int ClassType_obj::__FindIndex(::String inName)
{
	...
	if (inName==HX_("STAGE",9e,a2,f9,01)) return 1;
...
{
EVENT = ::hx::CreateConstEnum< ClassType_obj >(HX_("EVENT",fa,ff,b2,f3),0);
STAGE = ::hx::CreateConstEnum< ClassType_obj >(HX_("STAGE",9e,a2,f9,01),1);
}
