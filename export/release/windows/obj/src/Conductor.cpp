...
Float Conductor_obj::trackPosition;
...
HXDLIN(  60)		_hx_tmp(_hx_tmp1,::hx::SourceInfo(HX_("build/Conductor.hx",18,ec,b3,35),60,HX_("Conductor",c7,77,a1,7b),HX_("mapBPMChanges",a0,c9,ba,4a)));
            	}
...
bool Conductor_obj::__GetStatic(const ::String &inName, Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	...
	case 12:
		...
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"trackPosition") ) { outValue = ( trackPosition ); return true; }
...
bool Conductor_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,::hx::PropertyAccess inCallProp)
{
	...
	case 12:
		...
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"trackPosition") ) { trackPosition=ioValue.Cast< Float >(); return true; }
		break;
	case 14:
...
static ::hx::StaticInfo Conductor_obj_sStaticStorageInfo[] = {
	...
	{::hx::fsFloat,(void *) &Conductor_obj::trackPosition,HX_("trackPosition",54,ee,1d,e3)},
...
static void Conductor_obj_sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(Conductor_obj::trackPosition,"trackPosition");
...
static void Conductor_obj_sVisitStatics(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(Conductor_obj::trackPosition,"trackPosition");
