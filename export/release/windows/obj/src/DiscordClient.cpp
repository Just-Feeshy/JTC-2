...
HXLINE(  13)		::haxe::Log_obj::trace(HX_("Discord Client starting...",0d,5b,39,a8),::hx::SourceInfo(HX_("build/Discord.hx",33,49,22,9c),13,HX_("DiscordClient",f7,d0,c5,2b),HX_("new",60,d0,53,00)));
HXLINE(  14)		::discord_rpc::DiscordRpc_obj::start( ::Dynamic(::hx::Anon_obj::Create(4)
            			...
            			->setFixed(2,HX_("clientID",e6,72,8f,15),HX_("680224225809793025",34,62,a8,0d))
            			->setFixed(3,HX_("onReady",c4,3e,f8,7c),::DiscordClient_obj::onReady_dyn())));
HXLINE(  20)		::haxe::Log_obj::trace(HX_("Discord Client started.",8e,09,8e,36),::hx::SourceInfo(HX_("build/Discord.hx",33,49,22,9c),20,HX_("DiscordClient",f7,d0,c5,2b),HX_("new",60,d0,53,00)));
...
HXDLIN(  49)		::haxe::Log_obj::trace((((HX_("Error! ",87,92,5b,b7) + _code) + HX_(" : ",c6,7a,18,00)) + _message),::hx::SourceInfo(HX_("build/Discord.hx",33,49,22,9c),49,HX_("DiscordClient",f7,d0,c5,2b),HX_("onError",29,6a,67,09)));
            	}
...
HXDLIN(  54)		::haxe::Log_obj::trace((((HX_("Disconnected! ",7a,e1,87,53) + _code) + HX_(" : ",c6,7a,18,00)) + _message),::hx::SourceInfo(HX_("build/Discord.hx",33,49,22,9c),54,HX_("DiscordClient",f7,d0,c5,2b),HX_("onDisconnected",7a,eb,5a,b8)));
            	}
...
HXLINE(  63)		::haxe::Log_obj::trace(HX_("Discord Client initialized",f3,a9,32,06),::hx::SourceInfo(HX_("build/Discord.hx",33,49,22,9c),63,HX_("DiscordClient",f7,d0,c5,2b),HX_("initialize",50,31,bb,ec)));
            	}
...
HXLINE(  75)		::discord_rpc::DiscordRpc_obj::presence( ::Dynamic(::hx::Anon_obj::Create(8)
            			->setFixed(0,HX_("state",11,76,0b,84),state)
            			->setFixed(1,HX_("smallImageKey",eb,38,69,a3),HX_("help",c1,32,0b,45))
            			->setFixed(2,HX_("details",c2,dc,56,ab),details)
            			->setFixed(3,HX_("largeImageKey",df,8f,e3,ae),HX_("ww1",11,b4,5a,00))
            			...
            			->setFixed(6,HX_("largeImageText",6d,3e,2d,5e),HX_("Feesh lol'",83,4d,4e,56))
            			->setFixed(7,HX_("smallImageText",e1,7f,9b,5e),HX_("help me",57,e3,2a,c0))));
            	}
