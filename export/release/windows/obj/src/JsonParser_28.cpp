...
HX_DEFINE_STACK_FRAME(_hx_pos_a4949f0f39413048_938_new,"JsonParser_28","new",0x8a111af0,"JsonParser_28.new","json2object/reader/DataBuilder.hx",938,0x0533cd73)
HX_LOCAL_STACK_FRAME(_hx_pos_a4949f0f39413048_942_onIncorrectType,"JsonParser_28","onIncorrectType",0x9372e270,"JsonParser_28.onIncorrectType","json2object/reader/DataBuilder.hx",942,0x0533cd73)
HX_LOCAL_STACK_FRAME(_hx_pos_a4949f0f39413048_523_loadJsonNull,"JsonParser_28","loadJsonNull",0x89361085,"JsonParser_28.loadJsonNull","json2object/reader/DataBuilder.hx",523,0x0533cd73)
HX_LOCAL_STACK_FRAME(_hx_pos_a4949f0f39413048_515_loadJsonObject,"JsonParser_28","loadJsonObject",0x43a5ec3d,"JsonParser_28.loadJsonObject","json2object/reader/DataBuilder.hx",515,0x0533cd73)
HX_LOCAL_STACK_FRAME(_hx_pos_a4949f0f39413048_971_getAuto,"JsonParser_28","getAuto",0x4fd761b5,"JsonParser_28.getAuto","json2object/reader/DataBuilder.hx",971,0x0533cd73)
...
void JsonParser_28_obj::__construct(::Array< ::Dynamic> errors, ::json2object::PositionUtils putils, ::Dynamic __o_errorType){
            	...
            	HX_STACKFRAME(&_hx_pos_a4949f0f39413048_938_new)
...
void JsonParser_28_obj::onIncorrectType( ::Dynamic pos,::String variable){
            	HX_STACKFRAME(&_hx_pos_a4949f0f39413048_942_onIncorrectType)
HXLINE( 943)		this->errors->push(::json2object::Error_obj::IncorrectType(variable,HX_("haxe.ds.Map<String, Array<Array<Float>>>",64,1b,4e,b0),pos));
HXLINE( 944)		this->super::onIncorrectType(pos,variable);
            	}


void JsonParser_28_obj::loadJsonNull( ::Dynamic pos,::String variable){
            	HX_STACKFRAME(&_hx_pos_a4949f0f39413048_523_loadJsonNull)
HXDLIN( 523)		this->value = null();
            	}


void JsonParser_28_obj::loadJsonObject(::Array< ::Dynamic> o, ::Dynamic pos,::String variable){
            	HX_GC_STACKFRAME(&_hx_pos_a4949f0f39413048_515_loadJsonObject)
...
HXLINE( 518)					::Array< ::Dynamic> value;
HXLINE( 501)					try {
            						HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 518)						value = ( (::Array< ::Dynamic>)( ::JsonParser_29_obj::__alloc( HX_CTX ,this->errors,this->putils,2)->loadJson(field->value,field->name)) );
            					} catch( ::Dynamic _hx_e) {
            						if (_hx_e.IsClass<  ::Dynamic >() ){
            							HX_STACK_BEGIN_CATCH
            							 ::Dynamic _g = _hx_e;
...
HXLINE( 518)					( ( ::haxe::ds::StringMap)(this1) )->set(key,value);
 ...
 ::haxe::ds::StringMap JsonParser_28_obj::getAuto(){
            	HX_GC_STACKFRAME(&_hx_pos_a4949f0f39413048_971_getAuto)
HXDLIN( 971)		 ::JsonParser_28 _hx_tmp =  ::JsonParser_28_obj::__alloc( HX_CTX ,::Array_obj< ::Dynamic>::__new(0),this->putils,0);
