...
HX_LOCAL_STACK_FRAME(_hx_pos_730d362dee2b253d_5_onInit,"Mod","onInit",0x05e7c41b,"Mod.onInit","Mod.hx",5,0xf531c55c)
...
void Mod_obj::onInit(){
            	HX_GC_STACKFRAME(&_hx_pos_730d362dee2b253d_5_onInit)
HXDLIN(   5)		::Register_obj::attachLuaToState(::hx::ClassOf< ::MainMenuState >(), ::ModLua_obj::__alloc( HX_CTX ,::Paths_obj::lua(HX_("jtc_menu",85,2a,5c,17))));
            	}
