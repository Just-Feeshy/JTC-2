...
HX_DEFINE_STACK_FRAME(_hx_pos_66f21fcacf595f6d_335_new,"SongMetadata","new",0x0585a376,"SongMetadata.new","FreeplayState.hx",335,0x0d86f62d)
...
HXLINE( 339)		this->songCharacter = HX_("",00,00,00,00);
HXLINE( 338)		this->week = 0;
HXLINE( 337)		this->songName = HX_("",00,00,00,00);
HXLINE( 343)		this->songName = song;
HXLINE( 344)		this->week = week;
HXLINE( 345)		this->songCharacter = songCharacter;
            	}
