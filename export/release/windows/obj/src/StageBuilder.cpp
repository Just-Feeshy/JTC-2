...
HX_DEFINE_STACK_FRAME(_hx_pos_5edc43338caf40ab_16_new,"StageBuilder","new",0xffcb4b8f,"StageBuilder.new","StageBuilder.hx",16,0xa8c09ac1)
HX_LOCAL_STACK_FRAME(_hx_pos_5edc43338caf40ab_24_addToStage,"StageBuilder","addToStage",0x629abbd3,"StageBuilder.addToStage","StageBuilder.hx",24,0xa8c09ac1)
HX_LOCAL_STACK_FRAME(_hx_pos_5edc43338caf40ab_31_destroy,"StageBuilder","destroy",0x04ac6ba9,"StageBuilder.destroy","StageBuilder.hx",31,0xa8c09ac1)

void StageBuilder_obj::__construct(::String song){
            	HX_GC_STACKFRAME(&_hx_pos_5edc43338caf40ab_16_new)
HXLINE(  17)		super::__construct();
HXLINE(  19)		this->sprites =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE(  21)		this->song = song;
            	}
...
bool StageBuilder_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x28062add) {
		return inClassId==(int)0x00000001 || inClassId==(int)0x28062add;
	} else {
...
void StageBuilder_obj::addToStage(::String name, ::flixel::FlxBasic thing){
            	HX_STACKFRAME(&_hx_pos_5edc43338caf40ab_24_addToStage)
HXLINE(  25)		this->sprites->set(name,thing);
HXLINE(  27)		if (::Std_obj::isOfType(thing,::hx::ClassOf< ::PlayState >())) {
HXLINE(  28)			::flixel::FlxG_obj::game->_state->add(thing).StaticCast<  ::flixel::FlxBasic >();
            		}
            	}
...
void StageBuilder_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_5edc43338caf40ab_31_destroy)
HXLINE(  32)		if (::hx::IsNotNull( this->sprites )) {
HXLINE(  33)			{
HXLINE(  33)				 ::Dynamic k = this->sprites->keys();
...
HXLINE(  34)					( ( ::flixel::FlxBasic)(this->sprites->get(k1)) )->destroy();
            				}
            			}
HXLINE(  37)			this->sprites->clear();
            		}
HXLINE(  40)		this->sprites = null();
HXLINE(  41)		this->song = null();
            	}
...
::hx::ObjectPtr< StageBuilder_obj > StageBuilder_obj::__alloc(::hx::Ctx *_hx_ctx,::String song) {
	StageBuilder_obj *__this = (StageBuilder_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(StageBuilder_obj), true, "StageBuilder"));
...
void StageBuilder_obj::__register()
{
	...
	__mClass->mName = HX_("StageBuilder",1d,d8,24,3f);
