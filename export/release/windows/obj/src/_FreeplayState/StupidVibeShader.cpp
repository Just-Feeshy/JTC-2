...
HX_DEFINE_STACK_FRAME(_hx_pos_06b7999e40e2a89f_43_new,"_FreeplayState.StupidVibeShader","new",0xdec19500,"_FreeplayState.StupidVibeShader.new","FreeplayState.hx",43,0x0d86f62d)
namespace _FreeplayState{

void StupidVibeShader_obj::__construct(Float vibeMeter){
            	HX_STACKFRAME(&_hx_pos_06b7999e40e2a89f_43_new)
...
HXLINE(  46)		this->vibe->value = ::Array_obj< Float >::__new(1)->init(0,vibeMeter);
...
bool StupidVibeShader_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x04f93fcd) {
		if (inClassId<=(int)0x031b1768) {
			return inClassId==(int)0x00000001 || inClassId==(int)0x031b1768;
		} else {
...
::hx::ObjectPtr< StupidVibeShader_obj > StupidVibeShader_obj::__alloc(::hx::Ctx *_hx_ctx,Float vibeMeter) {
	StupidVibeShader_obj *__this = (StupidVibeShader_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(StupidVibeShader_obj), true, "_FreeplayState.StupidVibeShader"));
...
void StupidVibeShader_obj::__register()
{
	...
	__mClass->mName = HX_("_FreeplayState.StupidVibeShader",0e,55,9b,37);
