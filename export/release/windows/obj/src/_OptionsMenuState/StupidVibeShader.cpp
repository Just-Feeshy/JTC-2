...
HX_DEFINE_STACK_FRAME(_hx_pos_2294f4bc0b27489b_54_new,"_OptionsMenuState.StupidVibeShader","new",0x6d9d5d9f,"_OptionsMenuState.StupidVibeShader.new","OptionsMenuState.hx",54,0x18c6f26a)
namespace _OptionsMenuState{

void StupidVibeShader_obj::__construct(Float vibeMeter){
            	HX_STACKFRAME(&_hx_pos_2294f4bc0b27489b_54_new)
...
HXLINE(  57)		this->vibe->value = ::Array_obj< Float >::__new(1)->init(0,vibeMeter);
HXLINE(  41)		this->_hx___isGenerated = true;
HXDLIN(  41)		this->_hx___initGL();
            	}
...
bool StupidVibeShader_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x1efca5b6) {
		...
		return inClassId==(int)0x54eb2685 || inClassId==(int)0x78d8d737;
	}
}
...
::hx::ObjectPtr< StupidVibeShader_obj > StupidVibeShader_obj::__alloc(::hx::Ctx *_hx_ctx,Float vibeMeter) {
	StupidVibeShader_obj *__this = (StupidVibeShader_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(StupidVibeShader_obj), true, "_OptionsMenuState.StupidVibeShader"));
...
void StupidVibeShader_obj::__register()
{
	...
	__mClass->mName = HX_("_OptionsMenuState.StupidVibeShader",2d,a2,e0,0b);
