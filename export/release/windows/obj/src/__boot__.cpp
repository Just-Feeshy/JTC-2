...
#include <_FreeplayState/StupidVibeShader.h>
#endif
...
::json2object::InternalError_obj::__register();
::json2object::Error_obj::__register();
::hxjsonast::JsonValue_obj::__register();
...
::SaveType_obj::__register();
::ClassType_obj::__register();
::KeyboardScheme_obj::__register();
::Control_obj::__register();
::Device_obj::__register();
::FileType_obj::__register();
::ShaderType_obj::__register();
...
::__ASSET__assets_fonts_tahoma_bold_ttf_obj::__register();
...
::ChooseFeeshmora_obj::__register();
::CustomNoteHandler_obj::__register();
::CoolUtil_obj::__register();
::Conductor_obj::__register();
::Compile_obj::__register();
...
::json2object::PositionUtils_obj::__register();
::json2object::JsonParser_obj::__register();
::json2object::CustomFunctionError_obj::__register();
...
::hxjsonast::Position_obj::__register();
::hxjsonast::Parser_obj::__register();
::hxjsonast::JObjectField_obj::__register();
::hxjsonast::Json_obj::__register();
::hxjsonast::Error_obj::__register();
...
::WarningSubGroup_obj::__register();
::_UnicodeString::UnicodeString_Impl__obj::__register();
::Type_obj::__register();
::Sys_obj::__register();
::Strum_obj::__register();
...
::feshixl::group::FeshEventGroup_obj::__register();
::feshixl::group::IFeshEvent_obj::__register();
::Reflect_obj::__register();
::Preloader_obj::__register();
::PauseSubState_obj::__register();
::CustomKeys_obj::__register();
::OptionsSubState_obj::__register();
::OptionsMenuState_obj::__register();
::_OptionsMenuState::StupidVibeShader_obj::__register();
...
::__ASSET__OPENFL__assets_fonts_tahoma_bold_ttf_obj::__register();
...
::_MainMenuState::StupidVibeShader_obj::__register();
::MultiCallback_obj::__register();
::Lambda_obj::__register();
::JsonParser_9_obj::__register();
::JsonParser_7_obj::__register();
::JsonParser_5_obj::__register();
::JsonParser_31_obj::__register();
::JsonParser_30_obj::__register();
::JsonParser_3_obj::__register();
::JsonParser_29_obj::__register();
::JsonParser_25_obj::__register();
::JsonParser_23_obj::__register();
::JsonParser_21_obj::__register();
::JsonParser_20_obj::__register();
::JsonParser_2_obj::__register();
::JsonParser_18_obj::__register();
::JsonParser_16_obj::__register();
::JsonParser_15_obj::__register();
::JsonParser_14_obj::__register();
::JsonParser_13_obj::__register();
::JsonParser_11_obj::__register();
::JsonParser_1_obj::__register();
::IntIterator_obj::__register();
::HealthIcon_obj::__register();
::GitarooPause_obj::__register();
::GhostTapping_obj::__register();
...
::_FreeplayState::StupidVibeShader_obj::__register();
::FeeshSprite_obj::__register();
::JsonParser_28_obj::__register();
::json2object::reader::BaseParser_obj::__register();
::EReg_obj::__register();
::DiscordClient_obj::__register();
::DialogueBox_obj::__register();
::Date_obj::__register();
::CrewState_obj::__register();
::Controls_obj::__register();
::flixel::input::actions::FlxActionSet_obj::__register();
::CharacterCreatorState_obj::__register();
::CameraNote_obj::__register();
::betterShit::BetterCams_obj::__register();
::flixel::util::FlxPool_flixel_math_FlxPoint_obj::__register();
::CacheState_obj::__register();
...
::json2object::InternalError_obj::__boot();
::json2object::Error_obj::__boot();
::hxjsonast::JsonValue_obj::__boot();
...
::SaveType_obj::__boot();
::ClassType_obj::__boot();
::KeyboardScheme_obj::__boot();
::Control_obj::__boot();
::Device_obj::__boot();
::FileType_obj::__boot();
::ShaderType_obj::__boot();
...
::CoolUtil_obj::__boot();
::CustomNoteHandler_obj::__boot();
::ChooseFeeshmora_obj::__boot();
...
::__ASSET__assets_fonts_tahoma_bold_ttf_obj::__boot();
...
::Xml_obj::__boot();
::feshixl::filters::GuassianBlur_obj::__boot();
