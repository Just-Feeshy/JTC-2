...
HX_DEFINE_STACK_FRAME(_hx_pos_95b33a292328d79f_5_new,"example_code.DefaultStage","new",0xfb11ff1b,"example_code.DefaultStage.new","example_code/DefaultStage.hx",5,0x444bc5d4)
HX_LOCAL_STACK_FRAME(_hx_pos_95b33a292328d79f_16_setMainGameStage,"example_code.DefaultStage","setMainGameStage",0x332c4156,"example_code.DefaultStage.setMainGameStage","example_code/DefaultStage.hx",16,0x444bc5d4)
namespace example_code{

void DefaultStage_obj::__construct(::String song){
            	HX_STACKFRAME(&_hx_pos_95b33a292328d79f_5_new)
HXDLIN(   5)		super::__construct(song);
            	}
...
::String DefaultStage_obj::setMainGameStage(::String song){
            	HX_STACKFRAME(&_hx_pos_95b33a292328d79f_16_setMainGameStage)
HXDLIN(  16)		::String _hx_switch_0 = song.toLowerCase();
            		if (  (_hx_switch_0==HX_("cocoa",09,9d,55,4a)) ||  (_hx_switch_0==HX_("eggnog",61,04,ba,f4)) ){
HXLINE(  24)			return HX_("mall",d4,3a,56,48);
...
HXLINE(  18)			return HX_("spooky",eb,bd,9e,c1);
...
HXLINE(  20)			return HX_("philly",28,77,5e,ef);
