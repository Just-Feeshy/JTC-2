...
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1084_getScreenCenter,"flixel.FlxObject","getScreenCenter",0x4d46a5c8,"flixel.FlxObject.getScreenCenter","flixel/FlxObject.hx",1084,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1104_setPosition,"flixel.FlxObject","setPosition",0x265d9f9c,"flixel.FlxObject.setPosition","flixel/FlxObject.hx",1104,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1116_setSize,"flixel.FlxObject","setSize",0xa7896a34,"flixel.FlxObject.setSize","flixel/FlxObject.hx",1116,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1196_getBoundingBox,"flixel.FlxObject","getBoundingBox",0x58364780,"flixel.FlxObject.getBoundingBox","flixel/FlxObject.hx",1196,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1220_getRotatedBounds,"flixel.FlxObject","getRotatedBounds",0x6b926bb7,"flixel.FlxObject.getRotatedBounds","flixel/FlxObject.hx",1220,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1233_toString,"flixel.FlxObject","toString",0x9e14e2db,"flixel.FlxObject.toString","flixel/FlxObject.hx",1233,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1246_set_x,"flixel.FlxObject","set_x",0xb024e5cc,"flixel.FlxObject.set_x","flixel/FlxObject.hx",1246,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1252_set_y,"flixel.FlxObject","set_y",0xb024e5cd,"flixel.FlxObject.set_y","flixel/FlxObject.hx",1252,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1266_set_width,"flixel.FlxObject","set_width",0x7d06d55a,"flixel.FlxObject.set_width","flixel/FlxObject.hx",1266,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1280_set_height,"flixel.FlxObject","set_height",0x9f435213,"flixel.FlxObject.set_height","flixel/FlxObject.hx",1280,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1286_get_width,"flixel.FlxObject","get_width",0x99b5e94e,"flixel.FlxObject.get_width","flixel/FlxObject.hx",1286,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1292_get_height,"flixel.FlxObject","get_height",0x9bc5b39f,"flixel.FlxObject.get_height","flixel/FlxObject.hx",1292,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1298_get_solid,"flixel.FlxObject","get_solid",0x5018e773,"flixel.FlxObject.get_solid","flixel/FlxObject.hx",1298,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1303_set_solid,"flixel.FlxObject","set_solid",0x3369d37f,"flixel.FlxObject.set_solid","flixel/FlxObject.hx",1303,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1311_set_angle,"flixel.FlxObject","set_angle",0xd5866327,"flixel.FlxObject.set_angle","flixel/FlxObject.hx",1311,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1317_set_moves,"flixel.FlxObject","set_moves",0xbf09eb96,"flixel.FlxObject.set_moves","flixel/FlxObject.hx",1317,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1323_set_immovable,"flixel.FlxObject","set_immovable",0xc5b8805e,"flixel.FlxObject.set_immovable","flixel/FlxObject.hx",1323,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1329_set_pixelPerfectRender,"flixel.FlxObject","set_pixelPerfectRender",0x84233609,"flixel.FlxObject.set_pixelPerfectRender","flixel/FlxObject.hx",1329,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1335_set_allowCollisions,"flixel.FlxObject","set_allowCollisions",0x7975d9fe,"flixel.FlxObject.set_allowCollisions","flixel/FlxObject.hx",1335,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1360_set_path,"flixel.FlxObject","set_path",0xde100cd1,"flixel.FlxObject.set_path","flixel/FlxObject.hx",1360,0xf0fe0d80)
...
Float FlxObject_obj::getScreenCenter( ::flixel::util::FlxAxes axes){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1084_getScreenCenter)
HXLINE(1085)		if (::hx::IsPointerNotEq( axes,::flixel::util::FlxAxes_obj::Y_dyn() )) {
HXLINE(1086)			Float _hx_tmp = (( (Float)(::flixel::FlxG_obj::width) ) / ( (Float)(2) ));
HXDLIN(1086)			this->set_x((_hx_tmp - (this->get_width() / ( (Float)(2) ))));
HXLINE(1087)			return this->x;
            		}
            		else {
HXLINE(1088)			if (::hx::IsPointerNotEq( axes,::flixel::util::FlxAxes_obj::X_dyn() )) {
HXLINE(1089)				Float _hx_tmp = (( (Float)(::flixel::FlxG_obj::height) ) / ( (Float)(2) ));
HXDLIN(1089)				this->set_y((_hx_tmp - (this->get_height() / ( (Float)(2) ))));
HXLINE(1090)				return this->y;
            			}
            		}
HXLINE(1093)		return ( (Float)(0) );
            	}


HX_DEFINE_DYNAMIC_FUNC1(FlxObject_obj,getScreenCenter,return )

void FlxObject_obj::setPosition(::hx::Null< Float >  __o_X,::hx::Null< Float >  __o_Y){
            		Float X = __o_X.Default(0);
            		Float Y = __o_Y.Default(0);
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1104_setPosition)
HXLINE(1105)		this->set_x(X);
HXLINE(1106)		this->set_y(Y);
            	}
...
void FlxObject_obj::setSize(Float Width,Float Height){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1116_setSize)
HXLINE(1117)		this->set_width(Width);
HXLINE(1118)		this->set_height(Height);
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(FlxObject_obj,setSize,(void))
 ...
 ::flixel::math::FlxRect FlxObject_obj::getBoundingBox( ::flixel::FlxCamera camera){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1196_getBoundingBox)
HXLINE(1197)		this->getScreenPosition(this->_point,camera);
HXLINE(1199)		{
HXLINE(1199)			 ::flixel::math::FlxRect _this = this->_rect;
HXDLIN(1199)			Float X = this->_point->x;
HXDLIN(1199)			Float Y = this->_point->y;
HXDLIN(1199)			Float Width = this->get_width();
HXDLIN(1199)			Float Height = this->get_height();
HXDLIN(1199)			_this->x = X;
HXDLIN(1199)			_this->y = Y;
HXDLIN(1199)			_this->width = Width;
HXDLIN(1199)			_this->height = Height;
            		}
HXLINE(1200)		this->_rect = camera->transformRect(this->_rect);
HXLINE(1202)		if (this->isPixelPerfectRender(camera)) {
HXLINE(1204)			 ::flixel::math::FlxRect _this = this->_rect;
HXDLIN(1204)			_this->x = ( (Float)(::Math_obj::floor(_this->x)) );
HXDLIN(1204)			_this->y = ( (Float)(::Math_obj::floor(_this->y)) );
HXDLIN(1204)			_this->width = ( (Float)(::Math_obj::floor(_this->width)) );
HXDLIN(1204)			_this->height = ( (Float)(::Math_obj::floor(_this->height)) );
            		}
HXLINE(1207)		return this->_rect;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxObject_obj,getBoundingBox,return )
 ...
 ::flixel::math::FlxRect FlxObject_obj::getRotatedBounds( ::flixel::math::FlxRect newRect){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1220_getRotatedBounds)
HXLINE(1221)		if (::hx::IsNull( newRect )) {
HXLINE(1222)			 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN(1222)			_this->x = ( (Float)(0) );
HXDLIN(1222)			_this->y = ( (Float)(0) );
HXDLIN(1222)			_this->width = ( (Float)(0) );
HXDLIN(1222)			_this->height = ( (Float)(0) );
HXDLIN(1222)			 ::flixel::math::FlxRect rect = _this;
HXDLIN(1222)			rect->_inPool = false;
HXDLIN(1222)			newRect = rect;
            		}
HXLINE(1224)		{
HXLINE(1224)			Float X = this->x;
HXDLIN(1224)			Float Y = this->y;
HXDLIN(1224)			Float Width = this->get_width();
HXDLIN(1224)			Float Height = this->get_height();
HXDLIN(1224)			newRect->x = X;
HXDLIN(1224)			newRect->y = Y;
HXDLIN(1224)			newRect->width = Width;
HXDLIN(1224)			newRect->height = Height;
            		}
HXLINE(1225)		return newRect->getRotatedBounds(this->angle,null(),newRect);
            	}
...
::String FlxObject_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1233_toString)
HXLINE(1234)		 ::Dynamic value = this->x;
HXDLIN(1234)		 ::flixel::util::LabelValuePair _this = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN(1234)		_this->label = HX_("x",78,00,00,00);
HXDLIN(1234)		_this->value = value;
HXLINE(1235)		 ::Dynamic value1 = this->y;
HXDLIN(1235)		 ::flixel::util::LabelValuePair _this1 = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN(1235)		_this1->label = HX_("y",79,00,00,00);
HXDLIN(1235)		_this1->value = value1;
HXLINE(1236)		 ::Dynamic value2 = this->get_width();
HXDLIN(1236)		 ::flixel::util::LabelValuePair _this2 = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN(1236)		_this2->label = HX_("w",77,00,00,00);
HXDLIN(1236)		_this2->value = value2;
HXLINE(1237)		 ::Dynamic value3 = this->get_height();
HXDLIN(1237)		 ::flixel::util::LabelValuePair _this3 = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN(1237)		_this3->label = HX_("h",68,00,00,00);
HXDLIN(1237)		_this3->value = value3;
HXLINE(1238)		 ::Dynamic value4 = this->visible;
HXDLIN(1238)		 ::flixel::util::LabelValuePair _this4 = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN(1238)		_this4->label = HX_("visible",72,78,24,a3);
HXDLIN(1238)		_this4->value = value4;
HXLINE(1239)		 ::Dynamic value5 = this->velocity;
HXDLIN(1239)		 ::flixel::util::LabelValuePair _this5 = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN(1239)		_this5->label = HX_("velocity",1d,02,fe,1e);
HXDLIN(1239)		_this5->value = value5;
HXLINE(1233)		return ::flixel::util::FlxStringUtil_obj::getDebugString(::Array_obj< ::Dynamic>::__new(6)->init(0,_this)->init(1,_this1)->init(2,_this2)->init(3,_this3)->init(4,_this4)->init(5,_this5));
            	}


Float FlxObject_obj::set_x(Float NewX){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1246_set_x)
HXDLIN(1246)		return (this->x = NewX);
            	}
...
Float FlxObject_obj::set_y(Float NewY){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1252_set_y)
HXDLIN(1252)		return (this->y = NewY);
            	}
...
Float FlxObject_obj::set_width(Float Width){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1266_set_width)
HXDLIN(1266)		return (this->width = Width);
            	}
...
Float FlxObject_obj::set_height(Float Height){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1280_set_height)
HXDLIN(1280)		return (this->height = Height);
            	}
...
Float FlxObject_obj::get_width(){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1286_get_width)
HXDLIN(1286)		return this->width;
            	}
...
Float FlxObject_obj::get_height(){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1292_get_height)
HXDLIN(1292)		return this->height;
            	}
...
bool FlxObject_obj::get_solid(){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1298_get_solid)
HXDLIN(1298)		return ((this->allowCollisions & 4369) > 0);
            	}
...
bool FlxObject_obj::set_solid(bool Solid){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1303_set_solid)
HXLINE(1304)		int _hx_tmp;
HXDLIN(1304)		if (Solid) {
HXLINE(1304)			_hx_tmp = 4369;
            		}
            		else {
HXLINE(1304)			_hx_tmp = 0;
            		}
HXDLIN(1304)		this->set_allowCollisions(_hx_tmp);
HXLINE(1305)		return Solid;
            	}
...
Float FlxObject_obj::set_angle(Float Value){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1311_set_angle)
HXDLIN(1311)		return (this->angle = Value);
            	}
...
bool FlxObject_obj::set_moves(bool Value){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1317_set_moves)
HXDLIN(1317)		return (this->moves = Value);
            	}
...
bool FlxObject_obj::set_immovable(bool Value){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1323_set_immovable)
HXDLIN(1323)		return (this->immovable = Value);
            	}
...
bool FlxObject_obj::set_pixelPerfectRender(bool Value){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1329_set_pixelPerfectRender)
HXDLIN(1329)		return ( (bool)((this->pixelPerfectRender = Value)) );
            	}
...
int FlxObject_obj::set_allowCollisions(int Value){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1335_set_allowCollisions)
HXDLIN(1335)		return (this->allowCollisions = Value);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxObject_obj,set_allowCollisions,return )
 ...
 ::flixel::util::FlxPath FlxObject_obj::set_path( ::flixel::util::FlxPath path){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1360_set_path)
HXLINE(1361)		if (::hx::IsInstanceEq( this->path,path )) {
HXLINE(1362)			return path;
            		}
HXLINE(1364)		if (::hx::IsNotNull( this->path )) {
HXLINE(1365)			this->path->object = null();
            		}
HXLINE(1367)		if (::hx::IsNotNull( path )) {
HXLINE(1368)			path->object = ::hx::ObjectPtr<OBJ_>(this);
            		}
HXLINE(1369)		return (this->path = path);
            	}
...
::hx::Val FlxObject_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 15:
		...
		if (HX_FIELD_EQ(inName,"getScreenCenter") ) { return ::hx::Val( getScreenCenter_dyn() ); }
		break;
	case 16:
...
static ::String FlxObject_obj_sMemberFields[] = {
	...
	HX_("getScreenCenter",17,84,e3,05),
