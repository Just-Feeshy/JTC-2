...
HX_DEFINE_STACK_FRAME(_hx_pos_a2c5aad29e94c731_932_new,"flixel.group.FlxTypedGroupIterator","new",0xa7153fe6,"flixel.group.FlxTypedGroupIterator.new","flixel/group/FlxGroup.hx",932,0x1e89d58e)
HX_LOCAL_STACK_FRAME(_hx_pos_a2c5aad29e94c731_941_next,"flixel.group.FlxTypedGroupIterator","next",0x8b82aaad,"flixel.group.FlxTypedGroupIterator.next","flixel/group/FlxGroup.hx",941,0x1e89d58e)
HX_LOCAL_STACK_FRAME(_hx_pos_a2c5aad29e94c731_945_hasNext,"flixel.group.FlxTypedGroupIterator","hasNext",0x559d4ff3,"flixel.group.FlxTypedGroupIterator.hasNext","flixel/group/FlxGroup.hx",945,0x1e89d58e)
namespace flixel{
namespace group{

void FlxTypedGroupIterator_obj::__construct(::cpp::VirtualArray GroupMembers, ::Dynamic filter){
            	HX_STACKFRAME(&_hx_pos_a2c5aad29e94c731_932_new)
HXLINE( 933)		this->_groupMembers = GroupMembers;
HXLINE( 934)		this->_filter = filter;
HXLINE( 935)		this->_cursor = 0;
HXLINE( 936)		this->_length = this->_groupMembers->get_length();
            	}
...
bool FlxTypedGroupIterator_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic FlxTypedGroupIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_a2c5aad29e94c731_941_next)
HXDLIN( 941)		if (this->hasNext()) {
HXDLIN( 941)			return this->_groupMembers->__get(this->_cursor++);
            		}
            		else {
HXDLIN( 941)			return null();
            		}
HXDLIN( 941)		return null();
            	}
...
bool FlxTypedGroupIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_a2c5aad29e94c731_945_hasNext)
HXLINE( 946)		while(true){
HXLINE( 946)			bool _hx_tmp;
HXDLIN( 946)			if ((this->_cursor < this->_length)) {
HXLINE( 946)				if (::hx::IsNotNull( this->_groupMembers->__get(this->_cursor) )) {
HXLINE( 946)					if (::hx::IsNotNull( this->_filter )) {
HXLINE( 946)						_hx_tmp = !(( (bool)(this->_filter(this->_groupMembers->__get(this->_cursor))) ));
            					}
            					else {
...
HXLINE( 948)			this->_cursor++;
            		}
            		_hx_goto_2:;
HXLINE( 950)		return (this->_cursor < this->_length);
            	}
