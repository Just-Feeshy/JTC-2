...
HX_DEFINE_STACK_FRAME(_hx_pos_bfb78df8014a2c60_734_new,"polymod.PolymodError","new",0xa579457c,"polymod.PolymodError.new","polymod/Polymod.hx",734,0xd80c6d61)
namespace polymod{

void PolymodError_obj::__construct( ::polymod::PolymodErrorType severity,::String code,::String message,::String origin){
            	HX_STACKFRAME(&_hx_pos_bfb78df8014a2c60_734_new)
HXLINE( 735)		this->severity = severity;
HXLINE( 736)		this->code = code;
HXLINE( 737)		this->message = message;
HXLINE( 738)		this->origin = origin;
            	}
