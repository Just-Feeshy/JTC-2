...
HX_DEFINE_STACK_FRAME(_hx_pos_8d671e62deecd3f2_29_new,"polymod.backends.HEAPSBackend","new",0x8303f196,"polymod.backends.HEAPSBackend.new","polymod/backends/HEAPSBackend.hx",29,0x2ef036ba)
namespace polymod{
namespace backends{

void HEAPSBackend_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_8d671e62deecd3f2_29_new)
HXLINE(  30)		super::__construct();
HXLINE(  31)		::polymod::Polymod_obj::error(HX_("failed_create_backend",13,58,1e,db),HX_("HEAPSBackend requires the heaps library, did you forget to install it?",b3,3d,fc,0f),null());
            	}
