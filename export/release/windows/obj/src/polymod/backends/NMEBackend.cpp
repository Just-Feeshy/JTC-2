...
HX_DEFINE_STACK_FRAME(_hx_pos_4201ab7811db0480_25_new,"polymod.backends.NMEBackend","new",0x01681ab7,"polymod.backends.NMEBackend.new","polymod/backends/NMEBackend.hx",25,0x186804b9)
namespace polymod{
namespace backends{

void NMEBackend_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_4201ab7811db0480_25_new)
HXLINE(  26)		super::__construct();
HXLINE(  27)		::polymod::Polymod_obj::error(HX_("failed_create_backend",13,58,1e,db),HX_("NMEBackend requires the nme library, did you forget to install it?",f5,f5,d7,1a),null());
            	}
