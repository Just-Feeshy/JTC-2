...
HX_DEFINE_STACK_FRAME(_hx_pos_d14643276b7999de_13_new,"polymod.backends.StubBackend","new",0x31d2ab41,"polymod.backends.StubBackend.new","polymod/backends/StubBackend.hx",13,0xad5ab72f)
HX_LOCAL_STACK_FRAME(_hx_pos_d14643276b7999de_18_init,"polymod.backends.StubBackend","init",0x633be50f,"polymod.backends.StubBackend.init","polymod/backends/StubBackend.hx",18,0xad5ab72f)
HX_LOCAL_STACK_FRAME(_hx_pos_d14643276b7999de_22_destroy,"polymod.backends.StubBackend","destroy",0xd4a28c5b,"polymod.backends.StubBackend.destroy","polymod/backends/StubBackend.hx",22,0xad5ab72f)
HX_LOCAL_STACK_FRAME(_hx_pos_d14643276b7999de_26_clearCache,"polymod.backends.StubBackend","clearCache",0x6ae58cb4,"polymod.backends.StubBackend.clearCache","polymod/backends/StubBackend.hx",26,0xad5ab72f)
HX_LOCAL_STACK_FRAME(_hx_pos_d14643276b7999de_31_exists,"polymod.backends.StubBackend","exists",0xbe5e859b,"polymod.backends.StubBackend.exists","polymod/backends/StubBackend.hx",31,0xad5ab72f)
HX_LOCAL_STACK_FRAME(_hx_pos_d14643276b7999de_36_getBytes,"polymod.backends.StubBackend","getBytes",0x86262d74,"polymod.backends.StubBackend.getBytes","polymod/backends/StubBackend.hx",36,0xad5ab72f)
HX_LOCAL_STACK_FRAME(_hx_pos_d14643276b7999de_41_getText,"polymod.backends.StubBackend","getText",0xcf98dbc4,"polymod.backends.StubBackend.getText","polymod/backends/StubBackend.hx",41,0xad5ab72f)
HX_LOCAL_STACK_FRAME(_hx_pos_d14643276b7999de_46_getPath,"polymod.backends.StubBackend","getPath",0xccf0f4bc,"polymod.backends.StubBackend.getPath","polymod/backends/StubBackend.hx",46,0xad5ab72f)
HX_LOCAL_STACK_FRAME(_hx_pos_d14643276b7999de_51_list,"polymod.backends.StubBackend","list",0x6533c65d,"polymod.backends.StubBackend.list","polymod/backends/StubBackend.hx",51,0xad5ab72f)
HX_LOCAL_STACK_FRAME(_hx_pos_d14643276b7999de_56_stripAssetsPrefix,"polymod.backends.StubBackend","stripAssetsPrefix",0x4067a00e,"polymod.backends.StubBackend.stripAssetsPrefix","polymod/backends/StubBackend.hx",56,0xad5ab72f)
namespace polymod{
namespace backends{

void StubBackend_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_d14643276b7999de_13_new)
            	}
...
bool StubBackend_obj::init( ::Dynamic params){
            	HX_STACKFRAME(&_hx_pos_d14643276b7999de_18_init)
...
void StubBackend_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_d14643276b7999de_22_destroy)
            	}
...
void StubBackend_obj::clearCache(){
            	HX_STACKFRAME(&_hx_pos_d14643276b7999de_26_clearCache)
            	}
...
bool StubBackend_obj::exists(::String id){
            	HX_STACKFRAME(&_hx_pos_d14643276b7999de_31_exists)
...
HX_DEFINE_DYNAMIC_FUNC1(StubBackend_obj,exists,return )
 ...
 ::haxe::io::Bytes StubBackend_obj::getBytes(::String id){
            	HX_STACKFRAME(&_hx_pos_d14643276b7999de_36_getBytes)
...
::String StubBackend_obj::getText(::String id){
            	HX_STACKFRAME(&_hx_pos_d14643276b7999de_41_getText)
...
::String StubBackend_obj::getPath(::String id){
            	HX_STACKFRAME(&_hx_pos_d14643276b7999de_46_getPath)
...
::Array< ::String > StubBackend_obj::list(::String type){
            	HX_STACKFRAME(&_hx_pos_d14643276b7999de_51_list)
HXDLIN(  51)		return ::Array_obj< ::String >::__new(0);
            	}
...
::String StubBackend_obj::stripAssetsPrefix(::String id){
            	HX_STACKFRAME(&_hx_pos_d14643276b7999de_56_stripAssetsPrefix)
HXDLIN(  56)		return id;
            	}
