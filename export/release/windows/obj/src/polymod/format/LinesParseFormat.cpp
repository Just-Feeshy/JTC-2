...
HX_DEFINE_STACK_FRAME(_hx_pos_da011ef85b625651_400_new,"polymod.format.LinesParseFormat","new",0xde5818bc,"polymod.format.LinesParseFormat.new","polymod/format/ParseRules.hx",400,0xc5c5c43b)
HX_LOCAL_STACK_FRAME(_hx_pos_da011ef85b625651_406_parse,"polymod.format.LinesParseFormat","parse",0x5b41a78f,"polymod.format.LinesParseFormat.parse","polymod/format/ParseRules.hx",406,0xc5c5c43b)
HX_LOCAL_STACK_FRAME(_hx_pos_da011ef85b625651_437_append,"polymod.format.LinesParseFormat","append",0x207c3afe,"polymod.format.LinesParseFormat.append","polymod/format/ParseRules.hx",437,0xc5c5c43b)
HX_LOCAL_STACK_FRAME(_hx_pos_da011ef85b625651_441_merge,"polymod.format.LinesParseFormat","merge",0xa3b2ba14,"polymod.format.LinesParseFormat.merge","polymod/format/ParseRules.hx",441,0xc5c5c43b)
HX_LOCAL_STACK_FRAME(_hx_pos_da011ef85b625651_470_print,"polymod.format.LinesParseFormat","print",0x66776f89,"polymod.format.LinesParseFormat.print","polymod/format/ParseRules.hx",470,0xc5c5c43b)
HX_LOCAL_STACK_FRAME(_hx_pos_da011ef85b625651_475_getEndl,"polymod.format.LinesParseFormat","getEndl",0x183eb243,"polymod.format.LinesParseFormat.getEndl","polymod/format/ParseRules.hx",475,0xc5c5c43b)
namespace polymod{
namespace format{

void LinesParseFormat_obj::__construct( ::polymod::format::EndLineType endline){
            	HX_STACKFRAME(&_hx_pos_da011ef85b625651_400_new)
HXLINE( 401)		this->format = ::polymod::format::TextFileFormat_obj::LINES_dyn();
HXLINE( 402)		this->endline = endline;
            	}
...
::Array< ::String > LinesParseFormat_obj::parse(::String str){
            	HX_STACKFRAME(&_hx_pos_da011ef85b625651_406_parse)
HXLINE( 407)		bool _hx_tmp;
HXDLIN( 407)		if (::hx::IsNotNull( str )) {
HXLINE( 407)			_hx_tmp = (str == HX_("",00,00,00,00));
            		}
            		else {
HXLINE( 407)			_hx_tmp = true;
            		}
HXDLIN( 407)		if (_hx_tmp) {
HXLINE( 408)			return ::Array_obj< ::String >::__new(0);
            		}
HXLINE( 409)		::String other = HX_("",00,00,00,00);
HXLINE( 410)		::String endl = HX_("",00,00,00,00);
HXLINE( 411)		switch((int)(this->endline->_hx_getIndex())){
            			case (int)0: {
HXLINE( 414)				endl = HX_("\n",0a,00,00,00);
            			}
            			break;
            			case (int)1: {
HXLINE( 416)				endl = HX_("\r",0d,00,00,00);
            			}
            			break;
            			case (int)2: {
HXLINE( 418)				endl = HX_("\r\n",5d,0b,00,00);
...
HXLINE( 421)				other = HX_("\n",0a,00,00,00);
            			}
            		}
HXLINE( 423)		if ((other == HX_("",00,00,00,00))) {
HXLINE( 425)			return str.split(endl);
            		}
            		else {
HXLINE( 429)			str = ::StringTools_obj::replace(str,other,endl);
...
::String LinesParseFormat_obj::append(::String baseText,::String appendText,::String id){
            	HX_STACKFRAME(&_hx_pos_da011ef85b625651_437_append)
HXDLIN( 437)		return ::polymod::util::Util_obj::uCombine(::Array_obj< ::String >::__new(3)->init(0,baseText)->init(1,this->getEndl())->init(2,appendText));
            	}
...
::String LinesParseFormat_obj::merge(::String baseText,::String mergeText,::String id){
            	HX_STACKFRAME(&_hx_pos_da011ef85b625651_441_merge)
HXLINE( 442)		bool _hx_tmp;
HXDLIN( 442)		if (::hx::IsNotNull( baseText )) {
HXLINE( 442)			_hx_tmp = (mergeText == HX_("",00,00,00,00));
            		}
            		else {
HXLINE( 442)			_hx_tmp = true;
            		}
HXDLIN( 442)		if (_hx_tmp) {
HXLINE( 443)			return baseText;
            		}
HXLINE( 444)		bool _hx_tmp1;
HXDLIN( 444)		if (::hx::IsNotNull( baseText )) {
HXLINE( 444)			_hx_tmp1 = (mergeText == HX_("",00,00,00,00));
            		}
            		else {
HXLINE( 444)			_hx_tmp1 = true;
            		}
HXDLIN( 444)		if (_hx_tmp1) {
HXLINE( 445)			return baseText;
            		}
HXLINE( 446)		::Array< ::String > lines = this->parse(baseText);
HXLINE( 447)		bool _hx_tmp2;
HXDLIN( 447)		if (::hx::IsNotNull( lines )) {
HXLINE( 447)			_hx_tmp2 = (lines->length <= 0);
            		}
            		else {
...
HXLINE( 449)		::Array< ::String > mergeLines = this->parse(mergeText);
HXLINE( 450)		bool _hx_tmp3;
HXDLIN( 450)		if (::hx::IsNotNull( mergeLines )) {
HXLINE( 450)			_hx_tmp3 = (mergeLines->length <= 1);
            		}
            		else {
HXLINE( 450)			_hx_tmp3 = true;
            		}
HXDLIN( 450)		if (_hx_tmp3) {
HXLINE( 451)			return baseText;
            		}
HXLINE( 452)		::String pattern = ( (::String)(mergeLines->shift()) );
HXLINE( 453)		::Array< ::String > newLines = ::Array_obj< ::String >::__new(0);
HXLINE( 454)		{
HXLINE( 454)			int _g = 0;
HXDLIN( 454)			while((_g < lines->length)){
HXLINE( 454)				::String line = lines->__get(_g);
HXDLIN( 454)				_g = (_g + 1);
HXLINE( 456)				if ((line.indexOf(pattern,null()) == 0)) {
HXLINE( 458)					newLines = newLines->concat(mergeLines);
            				}
            				else {
HXLINE( 462)					newLines->push(line);
            				}
            			}
            		}
HXLINE( 465)		return ::polymod::util::Util_obj::uJoin(newLines,this->getEndl());
            	}
...
::String LinesParseFormat_obj::print(::Array< ::String > lines){
            	HX_STACKFRAME(&_hx_pos_da011ef85b625651_470_print)
HXDLIN( 470)		return lines->join(this->getEndl());
            	}
...
::String LinesParseFormat_obj::getEndl(){
            	HX_STACKFRAME(&_hx_pos_da011ef85b625651_475_getEndl)
HXDLIN( 475)		switch((int)(this->endline->_hx_getIndex())){
            			case (int)0: {
HXLINE( 477)				return HX_("\n",0a,00,00,00);
            			}
            			break;
            			case (int)1: {
HXLINE( 478)				return HX_("\r",0d,00,00,00);
            			}
            			break;
            			case (int)2: {
HXLINE( 479)				return HX_("\r\n",5d,0b,00,00);
            			}
            			break;
            			default:{
