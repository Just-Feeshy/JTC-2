...
HX_DEFINE_STACK_FRAME(_hx_pos_64f3b369f4c9efe8_19_new,"polymod.format.ParseRules","new",0x6e0082b5,"polymod.format.ParseRules.new","polymod/format/ParseRules.hx",19,0xc5c5c43b)
HX_LOCAL_STACK_FRAME(_hx_pos_64f3b369f4c9efe8_23_addType,"polymod.format.ParseRules","addType",0x81433650,"polymod.format.ParseRules.addType","polymod/format/ParseRules.hx",23,0xc5c5c43b)
HX_LOCAL_STACK_FRAME(_hx_pos_64f3b369f4c9efe8_39_get,"polymod.format.ParseRules","get",0x6dfb32eb,"polymod.format.ParseRules.get","polymod/format/ParseRules.hx",39,0xc5c5c43b)
HX_LOCAL_STACK_FRAME(_hx_pos_64f3b369f4c9efe8_44_addFormat,"polymod.format.ParseRules","addFormat",0x6791644d,"polymod.format.ParseRules.addFormat","polymod/format/ParseRules.hx",44,0xc5c5c43b)
HX_LOCAL_STACK_FRAME(_hx_pos_64f3b369f4c9efe8_49_addFile,"polymod.format.ParseRules","addFile",0x77f61212,"polymod.format.ParseRules.addFile","polymod/format/ParseRules.hx",49,0xc5c5c43b)
HX_LOCAL_STACK_FRAME(_hx_pos_64f3b369f4c9efe8_53_getDefault,"polymod.format.ParseRules","getDefault",0xdc12d116,"polymod.format.ParseRules.getDefault","polymod/format/ParseRules.hx",53,0xc5c5c43b)
namespace polymod{
namespace format{

void ParseRules_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_64f3b369f4c9efe8_19_new)
HXDLIN(  19)		this->formats =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            	}
...
void ParseRules_obj::addType(::String extension, ::polymod::format::TextFileFormat type){
            	HX_GC_STACKFRAME(&_hx_pos_64f3b369f4c9efe8_23_addType)
HXLINE(  24)		::Dynamic format;
HXDLIN(  24)		switch((int)(type->_hx_getIndex())){
            			case (int)0: {
HXLINE(  24)				format =  ::polymod::format::PlainTextParseFormat_obj::__alloc( HX_CTX );
            			}
            			break;
            			case (int)1: {
HXLINE(  24)				format =  ::polymod::format::LinesParseFormat_obj::__alloc( HX_CTX ,::polymod::format::EndLineType_obj::LF_dyn());
            			}
            			break;
            			case (int)2: {
HXLINE(  24)				format =  ::polymod::format::CSVParseFormat_obj::__alloc( HX_CTX ,HX_(",",2c,00,00,00),true);
            			}
            			break;
            			case (int)3: {
HXLINE(  24)				format =  ::polymod::format::TSVParseFormat_obj::__alloc( HX_CTX );
            			}
            			break;
            			case (int)4: {
HXLINE(  24)				format =  ::polymod::format::XMLParseFormat_obj::__alloc( HX_CTX ,null(),null(),null());
            			}
            			break;
            			case (int)5: {
HXLINE(  24)				format =  ::polymod::format::JSONParseFormat_obj::__alloc( HX_CTX ,null(),null());
            			}
            			break;
            		}
HXLINE(  34)		this->formats->set(extension,format);
            	}
...
::Dynamic ParseRules_obj::get(::String extension){
            	HX_STACKFRAME(&_hx_pos_64f3b369f4c9efe8_39_get)
HXDLIN(  39)		return this->formats->get(extension);
            	}
...
void ParseRules_obj::addFormat(::String extension,::Dynamic format){
            	HX_STACKFRAME(&_hx_pos_64f3b369f4c9efe8_44_addFormat)
HXDLIN(  44)		this->formats->set(extension,format);
            	}
...
void ParseRules_obj::addFile(::String path,::Dynamic format){
            	HX_STACKFRAME(&_hx_pos_64f3b369f4c9efe8_49_addFile)
HXDLIN(  49)		this->formats->set(path,format);
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(ParseRules_obj,addFile,(void))
 ...
 ::polymod::format::ParseRules ParseRules_obj::getDefault(){
            	HX_GC_STACKFRAME(&_hx_pos_64f3b369f4c9efe8_53_getDefault)
HXLINE(  54)		 ::polymod::format::ParseRules rules =  ::polymod::format::ParseRules_obj::__alloc( HX_CTX );
HXLINE(  55)		rules->addFormat(HX_("csv",c6,83,4b,00), ::polymod::format::CSVParseFormat_obj::__alloc( HX_CTX ,HX_(",",2c,00,00,00),true));
HXLINE(  56)		rules->addFormat(HX_("tsv",17,6a,58,00), ::polymod::format::TSVParseFormat_obj::__alloc( HX_CTX ));
HXLINE(  57)		rules->addFormat(HX_("xml",d7,6d,5b,00), ::polymod::format::XMLParseFormat_obj::__alloc( HX_CTX ,null(),null(),null()));
HXLINE(  58)		rules->addFormat(HX_("json",28,42,68,46), ::polymod::format::JSONParseFormat_obj::__alloc( HX_CTX ,null(),null()));
HXLINE(  59)		rules->addFormat(HX_("txt",70,6e,58,00), ::polymod::format::PlainTextParseFormat_obj::__alloc( HX_CTX ));
HXLINE(  60)		return rules;
            	}
