...
HX_DEFINE_STACK_FRAME(_hx_pos_b1a65a135ae92e24_109_new,"template.EventAddon","new",0xd41434cc,"template.EventAddon.new","template/CustomNote.hx",109,0xc1584e66)
HX_LOCAL_STACK_FRAME(_hx_pos_b1a65a135ae92e24_111_update,"template.EventAddon","update",0xebfead1d,"template.EventAddon.update","template/CustomNote.hx",111,0xc1584e66)
namespace _hx_template{

void EventAddon_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_b1a65a135ae92e24_109_new)
            	}
...
void EventAddon_obj::update(){
            	HX_STACKFRAME(&_hx_pos_b1a65a135ae92e24_111_update)
            	}
