...
HX_LOCAL_STACK_FRAME(_hx_pos_16decf10274984e4_47_setPixel,"template.StageBuilder","setPixel",0xc3318ac1,"template.StageBuilder.setPixel","template/StageBuilder.hx",47,0xc66da3ac)
HX_LOCAL_STACK_FRAME(_hx_pos_16decf10274984e4_55_destroy,"template.StageBuilder","destroy",0xd2f4c85d,"template.StageBuilder.destroy","template/StageBuilder.hx",55,0xc66da3ac)
...
void StageBuilder_obj::setPixel(bool is){
            	HX_STACKFRAME(&_hx_pos_16decf10274984e4_47_setPixel)
HXDLIN(  47)		if (::Std_obj::isOfType(::flixel::FlxG_obj::game->_state,::hx::ClassOf< ::PlayState >())) {
HXLINE(  48)			 ::PlayState state = ( ( ::PlayState)(::flixel::FlxG_obj::game->_state) );
HXLINE(  51)			state->isPixel = is;
            		}
            	}


HX_DEFINE_DYNAMIC_FUNC1(StageBuilder_obj,setPixel,(void))

void StageBuilder_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_16decf10274984e4_55_destroy)
HXLINE(  56)		if (::hx::IsNotNull( this->sprites )) {
HXLINE(  57)			{
HXLINE(  57)				 ::Dynamic k = this->sprites->keys();
...
HXLINE(  58)					( ( ::flixel::FlxBasic)(this->sprites->get(k1)) )->destroy();
            				}
            			}
HXLINE(  61)			this->sprites->clear();
            		}
HXLINE(  64)		this->sprites = null();
HXLINE(  65)		this->song = null();
HXLINE(  66)		this->directory = null();
            	}
